...
#          Max-Florian Bidlingmaier <maks@konsolan.de> - Opt changes
#
#=============================================================
usage() {
cat << EOF
...
cd ${THEDIR}
tar czSf $resPath/oracleResources/container-scriptsFR.tgz -C container-scripts .
tar czSf $resPath/oracleResources/fmwscripts.tgz -C install .
...
# BUILDING THE IMAGE #
# ################## #
buildCmd="docker build $BUILD_OPTS --force-rm=true --build-arg RESSRV=$RESSRV $PROXY_SETTINGS -t $IMAGE_NAME -f $DOCKERFILE_NAME ."
